    ...
    render() {
        return (
            <div id="animation-name">
                ...
                {!this.state.focus && (<span className="name-value" onClick={() => this.setState({focus: true})}>{this.props.currentName || 'name'}.json</span>)}
                {this.state.focus && (
                    <input autoFocus
...
class Mood extends React.PureComponent {
    render() {
        return (
            <div id="animation-mood">
                <span>Animation mood: </span>
                ...
            </div>
        );
    }
    ...
    render() {
        return (
            <div id="wrapper">
                ...
                { /*<AnimationControls /> TODO: Move all controls here */}
                <div id="animation-controls">
                    <Filename action={this.setFilename.bind(this)} currentName={this.state.animation.name} />
                    <Mood action={/*this.setMood.bind(this}*/ null} currentMoods={/*this.state.currentMoods*/ null}/>
                    ...
                    <div className="control-group">
                      ...
                      <div className="frame-change control-group">
                        <Button 
                            action={() => this.setCurrentFrame(0)} 
                            text="<|" 
                        />
                        ...
                        <Button 
                            action={() => this.setCurrentFrame(this.state.animation.frames.length - 1)} 
                            text=">>" 
                        /> 
                    </div>
